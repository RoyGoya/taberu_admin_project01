...
class NutritionFactor(Base):
    ...
    def __init__(self, pattern1=None, pattern2=None,
                 pattern3=None, pattern4=None, is_active=None,
    ...
    def __repr__(self):
        return '<Nutrition Factor %r>' % (self.eng_name)


class NutritionFactorSet(Base):
    __tablename__ = 'nutrition_factor_set'
    nutrition_dt_pattern = Column(CHAR(1), primary_key=True)
    nutrition_nt_pattern1 = Column(CHAR(1), primary_key=True)
    nutrition_nt_pattern2 = Column(CHAR(2), primary_key=True)
    ...
    def __init__(self, nutrition_dt_pattern=None,
                 nutrition_nt_pattern1=None,
                 nutrition_nt_pattern2=None, nutrition_serial=None,
        ...
        self.nutrition_nt_pattern1 = nutrition_nt_pattern1
        self.nutrition_nt_pattern2 = nutrition_nt_pattern2
